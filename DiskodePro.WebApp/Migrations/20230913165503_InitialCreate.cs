    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersFollowUsers", x => new { x.FollowerId, x.FolloweeId });
                    table.ForeignKey(
                        name: "FK_UsersFollowUsers_Users_FolloweeId",
                        column: x => x.FolloweeId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UsersFollowUsers_Users_FollowerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsersFollowUsers_FolloweeId",
                table: "UsersFollowUsers",
                column: "FolloweeId");
        }
